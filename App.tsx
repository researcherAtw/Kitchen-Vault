...
const RecipeDetail: React.FC<{ 
  ...
  return (
    <div className="fixed inset-0 z-50 bg-[#FDFBF7] animate-in slide-in-from-bottom duration-300 overflow-hidden font-sans">
      ...
      <button onClick={onClose} className="fixed top-12 left-6 z-[60] p-3 bg-white/90 backdrop-blur-md rounded-2xl text-gray-900 shadow-xl active:scale-90 transition-transform">
        <BackIcon />
      </button>
      ...
      >
        {RECIPES.map((recipe, idx) => {
          ...
          return (
            <div key={recipe.id} className="w-screen h-full flex-shrink-0 overflow-y-auto hide-scrollbar pb-24">
                        ...
                        {recipe.ingredients.map((ing) => {
                          ...
                          return (
                            <div 
                              ...
                              className="flex items-center justify-between p-4 rounded-2xl bg-gray-50/40 border border-transparent active:border-gray-200 transition-all cursor-pointer"
                            >
              ...
              {RECIPES.map((recipe, index) => {
                ...
                return (
                  <div 
                    ...
                    className="group relative bg-white rounded-[32px] p-3 sm:p-5 flex flex-col shadow-sm border border-gray-50 active:scale-[0.98] transition-all hover:shadow-xl cursor-pointer overflow-visible"
                  >
                    {/* REALISTIC RECTANGULAR STICKER TAG */}
                    ...
                    <div className="flex flex-col flex-1 px-1">
                      ...
                      <div className="flex flex-wrap items-center gap-x-3 gap-y-1 sm:gap-x-5 text-gray-400 text-[9px] sm:text-[10px] font-bold uppercase tracking-tight mt-auto pt-2 pb-1">
      ...
      <nav className="fixed bottom-8 left-1/2 -translate-x-1/2 bg-white/95 backdrop-blur-2xl border border-white/60 px-4 py-2.5 rounded-full shadow-[0_25px_60px_-15px_rgba(0,0,0,0.12)] z-40">
        <div className="relative flex items-center h-12">
          <div 
            ...
            style={{ left: 0, transform: `translateX(${activeTab === 'recipes' ? '24px' : '105px'})` }}
          />
          <button onClick={() => setActiveTab('recipes')} className="w-20 flex flex-col items-center justify-center group active:scale-90 transition-all relative z-10">
            <div className="p-1.5 flex items-center justify-center"><RecipeIcon active={activeTab === 'recipes'} /></div>
          ...
          <button onClick={() => setActiveTab('menu')} className="w-20 flex flex-col items-center justify-center group active:scale-90 transition-all relative z-10">
            <div className="p-1.5 flex items-center justify-center"><MenuIcon active={activeTab === 'menu'} /></div>
